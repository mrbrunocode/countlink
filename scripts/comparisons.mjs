...
export const COMPARISONS = [
...

  {
    ...
    faq: [
      ...
      { q: "What does Stagetimer's free tier actually allow?", a: "Three live connections per room and three timers per room, across three rooms, plus audio chimes, CSV import/export, API access and a custom logo. Verified against their pricing page on 6 September 2026." },
